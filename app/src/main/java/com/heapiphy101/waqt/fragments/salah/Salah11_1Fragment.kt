...
class Salah11_1Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_salah11_1, container, false)

        val backButtonSalah11_1: ImageButton = view.findViewById(R.id.backButtonSalah11_1)

        val forwordButtonSalah11_1: ImageButton = view.findViewById(R.id.forwordButtonSalah11_1)

        forwordButtonSalah11_1.setOnClickListener {
        ...
        backButtonSalah11_1.setOnClickListener {
            onBackPressed()
        }
