...
class Salah11_3Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_salah11_3, container, false)

        val backButtonSalah11_3: ImageButton = view.findViewById(R.id.backButtonSalah11_3)

        val forwordButtonSalah11_3: ImageButton = view.findViewById(R.id.forwordButtonSalah11_3)

        forwordButtonSalah11_3.setOnClickListener {
        ...
        backButtonSalah11_3.setOnClickListener {
            onBackPressed()
        }
