...
class Adhan03Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_adhan03, container, false)

        val backButtonAdhan03: ImageButton = view.findViewById(R.id.backButtonAdhan03)


        val forwordButtonAdhan03: ImageButton = view.findViewById(R.id.forwordButtonAdhan03)

        forwordButtonAdhan03.setOnClickListener {
        ...
        backButtonAdhan03.setOnClickListener {
            onBackPressed()
        }
