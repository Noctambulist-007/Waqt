...
class Ablution02_2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_ablution02_2, container, false)

        val backButtonAblution02_2: ImageButton = view.findViewById(R.id.backButtonAblution02_2)

        val forwordButtonAblution02_2: ImageButton = view.findViewById(R.id.forwordButtonAblution02_2)

        forwordButtonAblution02_2.setOnClickListener {
        ...
        backButtonAblution02_2.setOnClickListener {
            onBackPressed()
        }
