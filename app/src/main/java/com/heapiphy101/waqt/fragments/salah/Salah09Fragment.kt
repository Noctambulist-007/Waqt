...
class Salah09Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_salah09, container, false)

        val backButtonSalah09: ImageButton = view.findViewById(R.id.backButtonSalah09)

        val forwordButtonSalah09: ImageButton = view.findViewById(R.id.forwordButtonSalah09)

        forwordButtonSalah09.setOnClickListener {
        ...
        backButtonSalah09.setOnClickListener {
            onBackPressed()
        }
