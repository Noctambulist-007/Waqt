...
class Ablution02_1Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_ablution02_1, container, false)

        val backButtonAblution02_1: ImageButton = view.findViewById(R.id.backButtonAblution02_1)

        val forwordButtonAblution02_1: ImageButton = view.findViewById(R.id.forwordButtonAblution02_1)

        forwordButtonAblution02_1.setOnClickListener {
        ...
        backButtonAblution02_1.setOnClickListener {
            onBackPressed()
        }
