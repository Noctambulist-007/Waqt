...
class Salah07Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_salah07, container, false)

        val backButtonSalah07: ImageButton = view.findViewById(R.id.backButtonSalah07)

        val forwordButtonSalah07: ImageButton = view.findViewById(R.id.forwordButtonSalah07)

        forwordButtonSalah07.setOnClickListener {
        ...
        backButtonSalah07.setOnClickListener {
            onBackPressed()
        }
