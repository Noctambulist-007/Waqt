...
class Salah08Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_salah08, container, false)

        val backButtonSalah08: ImageButton = view.findViewById(R.id.backButtonSalah08)

        val forwordButtonSalah08: ImageButton = view.findViewById(R.id.forwordButtonSalah08)

        forwordButtonSalah08.setOnClickListener {
        ...
        backButtonSalah08.setOnClickListener {
            onBackPressed()
        }
