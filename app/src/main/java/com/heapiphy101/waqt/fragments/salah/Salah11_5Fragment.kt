...
class Salah11_5Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_salah11_5, container, false)

        val backButtonSalah11_5: ImageButton = view.findViewById(R.id.backButtonSalah11_5)

        val forwordButtonSalah11_5: ImageButton = view.findViewById(R.id.forwordButtonSalah11_5)

        forwordButtonSalah11_5.setOnClickListener {
        ...
        backButtonSalah11_5.setOnClickListener {
            onBackPressed()
        }
