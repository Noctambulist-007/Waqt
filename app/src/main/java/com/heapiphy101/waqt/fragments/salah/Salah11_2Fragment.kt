...
class Salah11_2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_salah11_2, container, false)

        val backButtonSalah11_2: ImageButton = view.findViewById(R.id.backButtonSalah11_2)

        val forwordButtonSalah11_2: ImageButton = view.findViewById(R.id.forwordButtonSalah11_2)

        forwordButtonSalah11_2.setOnClickListener {
        ...
        backButtonSalah11_2.setOnClickListener {
            onBackPressed()
        }
