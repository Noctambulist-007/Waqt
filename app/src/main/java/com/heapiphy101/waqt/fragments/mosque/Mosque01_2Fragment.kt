...
class Mosque01_2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_mosque01_2, container, false)

        val backButtonMosque01_2: ImageButton = view.findViewById(R.id.backButtonMosque01_2)

        val forwordButtonMosque01_2: ImageButton = view.findViewById(R.id.forwordButtonMosque01_2)

        forwordButtonMosque01_2.setOnClickListener {
        ...
        backButtonMosque01_2.setOnClickListener {
            onBackPressed()
        }
