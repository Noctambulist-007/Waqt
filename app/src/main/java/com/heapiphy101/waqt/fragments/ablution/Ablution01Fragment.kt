...
class Ablution01Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_ablution01, container, false)

        val backButtonAblution01: ImageButton = view.findViewById(R.id.backButtonAblution01)

        val forwordButtonAblution01: ImageButton = view.findViewById(R.id.forwordButtonAblution01)

        forwordButtonAblution01.setOnClickListener {
        ...
        backButtonAblution01.setOnClickListener {
            onBackPressed()
        }
